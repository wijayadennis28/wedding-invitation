...
function wedding_invitation_scripts() {
    ...
    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css2?family=Allura:wght@400&family=Aniyah&display=swap', array(), '1.0.0');
    ...
    wp_enqueue_script('wedding-scripts', get_template_directory_uri() . '/assets/js/wedding-scripts.js', array('gsap', 'aos-js'), '1.0.0', true);
