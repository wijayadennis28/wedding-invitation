...
<section id="wedding-details" class="wedding-details-section relative min-h-screen">
    ...
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="Wedding Details" class="w-full h-full object-cover">
...
<section id="ceremony-reception" class="ceremony-reception-section relative min-h-screen">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="Ceremony Reception" class="w-full h-full object-cover">
...
<section id="detailed-love-story" class="detailed-love-story-section relative min-h-screen">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="Detailed Love Story" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-black/60"></div>
    </div>
...
<section id="final-love-story" class="final-love-story-section relative min-h-screen">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="Final Love Story" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-black/60"></div>
    </div>
...
<section id="image-slider" class="image-slider-section relative min-h-screen">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="Image Slider" class="w-full h-full object-cover">
        <div class="absolute inset-0 bg-gradient-to-t from-black/80 to-black/60"></div>
    </div>
...
<section id="rsvp" class="rsvp-section relative min-h-screen">
    <!-- Background Image -->
    <div class="absolute inset-0 z-0">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg" alt="RSVP" class="w-full h-full object-cover">
