...
<section class="dynamic-section relative min-h-screen">
    ...
    <div class="content-wrapper fixed inset-0 flex items-center justify-center z-10">
        <div class="w-full mx-auto px-4 text-center relative" style="position: fixed; top: 20%; left: 50%; transform: translate(-50%, -50%); width: 100%; max-width: none;">
            ...
            <div id="invitation-content" class="content-container max-w-2xl mx-auto hidden fixed bottom-[15%] left-1/2 transform -translate-x-1/2 w-full z-20 max-w-[90vw]">
                <div class="invitation-text mt-48 mb-48">
                    <h2 class="greeting-title text-sm md:text-2xl font-light text-white mb-6 tracking-wide">
                        DEAR MR. JOHN AND MRS. JANE,
                    </h2>
                    <p class="invitation-message text-sm md:text-base text-white leading-relaxed mb-6">
            ...
            <div id="wedding-details-content" class="content-container max-w-2xl mx-auto hidden fixed top-0 left-1/2 transform -translate-x-1/2 w-full z-30 overflow-y-auto">
                <div class="wedding-details-inner flex flex-col py-2 px-4 text-center">
                    <!-- Wedding Title -->
                    <div class="wedding-title-section mb-4 text-center">
                        <h2 class="wedding-title text-lg md:text-xl font-light text-white mb-4 tracking-wider italic">
                            The wedding of
                        </h2>
                        <h1 class="wedding-couple-names text-2xl md:text-3xl font-medium text-white tracking-wider leading-tight">
                            <?php echo strtoupper($groom_name . ' AND ' . $bride_name); ?>
                        </h1>
                    </div>
                    
                    <!-- Wedding Date -->
                    <div class="wedding-date-section mt-8 mb-12 text-center">
                        <p class="wedding-date text-base md:text-lg text-white font-light tracking-wide">
                            Saturday, 22 November 2025
                        </p>
                    </div>
                    
                    <!-- Bible Verse -->
                    <div class="bible-verse-section mb-12 text-center">
                        <p class="bible-verse text-sm md:text-base text-white font-light leading-relaxed max-w-lg mx-auto">
                            "Love knows no limit to its endurance, <br>
                            no end to its trust, love still stands <br>
                            when all else has fallen."<br>
                            <span class="verse-reference mt-12 text-xs tracking-wider block">1 Corinthians 13:7-8</span>
                        </p>
                    </div>
                    
                    <!-- Wedding Details -->
                    <div class="wedding-info-section mb-12 text-center">
                        <div class="grid grid-cols-2 gap-8 max-w-lg mx-auto">
                            <div class="groom-info">
                                <h3 class="person-name text-lg text-white font-medium mb-2">Dennis Wijaya</h3>
                                <p class="person-details text-sm text-white font-light">
                                    First son of<br>
                            ...
                            <div class="bride-info">
                                <h3 class="person-name text-lg text-white font-medium mb-2">Emilia Bewintara</h3>
                                <p class="person-details text-sm text-white font-light">
                    ...
                    <div class="details-rsvp-section text-center">
                        <p class="details-rsvp-text text-sm text-white font-light tracking-wider mt-12 mb-4">
                            SCROLL TO RSVP
                        </p>
            ...
            <div id="ceremony-reception-content" class="content-container max-w-2xl mx-auto hidden fixed top-0 left-1/2 transform -translate-x-1/2 w-full z-40 overflow-y-auto">
                <div class="ceremony-reception-inner flex flex-col py-2 px-4 text-center">
                    <p class="ceremony-intro">We request the blessing of your presence as we are united in</p>
                    <h2 class="ceremony-title md:text-xl tracking-widest mb-2">HOLY MATRIMONY</h2>
                    <div class="ceremony-time tracking-wider mb-2">9 AM ONWARD</div>
                    <div class="ceremony-location mb-2">
                        <div class="ceremony-place font-semibold tracking-widest text-base md:text-lg">GEREJA KATOLIK<br>SANTO LAURENSIUS</div>
                        <div class="ceremony-address text-xs md:text-sm font-light italic mt-1 mb-2">Jl. Sutera Utama No. 2, Alam Sutera<br>Tangerang, Banten 15326</div>
                    ...
                    <hr class="ceremony-divider my-6 border-white/30 mt-12 mb-12">
                    <p class="reception-intro">We request the pleasure of your company at our</p>
                    <h2 class="reception-title text-lg md:text-xl font-light text-white tracking-widest mb-2">EVENING RECEPTION</h2>
                    <div class="reception-time text-white font-semibold tracking-wider mb-2">6 PM ONWARD</div>
                    <div class="reception-location text-white mb-2">
                        <div class="reception-place font-semibold tracking-widest text-base md:text-lg">JHL SOLITAIRE</div>
                        <div class="reception-address text-xs md:text-sm font-light italic mt-1 mb-2">Jl. Gading Serpong Boulevard,<br>Blok S no. 5, Gading Serpong,<br>Tangerang, Banten 15810</div>
                    ...
                    <div class="rsvp-section text-center mt-14">
                        <p class="ceremony-rsvp-text text-sm text-white font-light tracking-wider mb-4">SCROLL TO RSVP</p>
                        <div class="scroll-indicator">
            ...
            <div id="love-story-content" class="content-container max-w-2xl mx-auto hidden fixed top-0 left-1/2 transform -translate-x-1/2 w-full z-50 overflow-y-auto">
                <div class="love-story-inner flex flex-col py-8 px-4 text-center">
                    <!-- Love Story Title -->
                    <h2 class="love-story-title text-xl md:text-2xl font-bold mb-8 tracking-wider italic">
                        The Love Story
                    </h2>
                    
                    <!-- Video Container -->
                    <div class="love-story-video-container mb-8 relative">
                        <div class="video-placeholder bg-gray-800 rounded-lg overflow-hidden relative aspect-video max-w-md mx-auto">
                            <!-- Placeholder for video -->
                            <div class="video-overlay absolute inset-0 bg-black/50 flex items-center justify-center">
                                <div class="play-button w-16 h-16 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                                    <div class="play-icon w-0 h-0 border-l-[20px] border-l-white border-t-[12px] border-t-transparent border-b-[12px] border-b-transparent ml-1"></div>
                                </div>
                            </div>
                            <!-- Placeholder image -->
                    ...
                    <!-- Love Quote -->
                    <div class="love-quote-section mb-8">
                        <p class="love-quote text-sm md:text-base text-white font-light italic leading-relaxed max-w-sm mx-auto">
                    ...
                    <div class="love-story-rsvp-section text-center">
                        <p class="love-story-rsvp-text text-sm text-white font-light tracking-wider mb-4">
                            SCROLL TO RSVP
                        </p>
                        <div class="scroll-indicator">
            ...
            <div id="detailed-love-story-content" class="content-container max-w-2xl mx-auto hidden fixed top-[5%] left-1/2 transform -translate-x-1/2 w-full z-50 overflow-y-auto h-[90vh]">
                <div class="detailed-love-story-inner flex flex-col py-4 px-4 text-center">
                    <!-- Love Story Title -->
            ...
            <div id="final-love-story-content" class="content-container max-w-2xl mx-auto hidden fixed top-[5%] left-1/2 transform -translate-x-1/2 w-full z-50 overflow-y-auto h-[90vh]">
                <div class="final-love-story-inner flex flex-col py-4 px-4 text-center">                    
                    <!-- Love Story Title -->
                    <h2 class="final-love-story-title text-xl md:text-2xl font-bold mb-6 tracking-wider">
                        The Love Story
                    </h2>
            ...
            <div id="image-slider-content" class="content-container max-w-2xl mx-auto hidden fixed top-[5%] left-1/2 transform -translate-x-1/2 w-full z-50 overflow-y-auto h-[90vh]">
                <div class="image-slider-inner flex flex-col py-4 px-4 text-center">                    
                    <!-- Romantic Quote -->
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function switchToInvitation() {
        ...
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToWeddingDetails() {
        ...
        // Change background image (keep same as invitation)
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToCeremonyReception() {
        ...
        // Change background image for ceremony (same as wedding details)
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToLoveStory() {
        ...
        // Change background image for love story
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToDetailedLoveStory() {
        ...
        // Change background image for detailed love story
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToFinalLoveStory() {
        ...
        // Change background image for final love story
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToImageSlider() {
        ...
        // Change background image for image slider
        backgroundImage.src = '<?php echo get_template_directory_uri(); ?>/assets/images/s.jpg';
    ...
    function switchToHero() {
        ...
        // Change background image back - check current device size
